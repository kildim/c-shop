                  ...
                  <div className="product-card">
                    <div className="product-card__img">
                      <picture>
                        ...
                        <img src="img/content/img1.jpg" srcSet="img/content/img1@2x.jpg 2x" width="280" height="240"
                  ...
                  <div className="product-card">
                    <div className="product-card__img">
                      <picture>
                        ...
                        <img src="img/content/img9.jpg" srcSet="img/content/img9@2x.jpg 2x" width="280" height="240"
