...
function ModalError(props: ModalErrorProps): JSX.Element {
  ...
  return (
    <div className="modal__content">
      ...
      <p className="title title--h4">Сервер отклонил</p>
      <p className="title title--h4">размещение заказа!</p>

      <svg className="modal__icon" width="86" height="80" aria-hidden="true">
        <use xlinkHref="#icon-fail"></use>
      </svg>
      <div className="modal__buttons">
        <button className="btn btn--purple modal__btn modal__btn--fit-width" onClick={onClosePopup}>
          Закрыть
        </button>
      </div>
