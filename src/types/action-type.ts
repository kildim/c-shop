export enum ActionType {
  SetIsSuccessfulAddToBasketShown = 'cameras/setIsSuccessfulAddToBasketShown',
  SetIsBuyPopupShown = 'cameras/setIsBuyPopupShown',
  SetIsReviewPosting = 'cameras/setIsReviewPosting',
